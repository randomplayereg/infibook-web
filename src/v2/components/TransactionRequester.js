...
let ruben = new LocalizedStrings({
    ...
    vi: {
        ...
        status_set: {
            3: "Đang chờ phản hồi của chủ sách",
            4: "4",
...
class TransactionRequester extends React.Component {
    ...
    fetchTransaction() {
        ...
        fetch(
            ...
            .then(
                json => {
                    this.setState({
                        transactions: json.filter((item) => {return item.requester_email === currentEmail})
                    });
                    console.log(json);
            ...
            <div>
                ...
                <Grid>
                    <Row style={{ padding: '0px 0px',
                        ...
                        <h2 style={{margin: 'auto'}}>Giao dịch mượn của bạn</h2>
                    </Row>
                </Grid>
                    ...
                    <Col md={9}>
                        <Row>
                            <div className="customize-group-container">
                                ...
                                <button className="customize-group-radio" onClick={()=>this.groupFilter('my_request')}>{ruben.my_request}</button>
                            </div>
                        </Row>
...
export default TransactionRequester;